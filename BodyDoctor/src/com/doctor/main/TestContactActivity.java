...
import com.doctor.tool.PinyinComparator;
import com.doctor.tool.SideBar;
...
public class TestContactActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findView();
        //nicks1 = getData();
        System.out.println("长度："+nicks1.length+"内容："+nicks1[0]+nicks1[1]+nicks1[2]+nicks1[3]);
    }
    ...
    static class ContactAdapter extends BaseAdapter implements SectionIndexer {  
    	...
    	public String[] name() {
    	    String[] mNicks = {"阿雅","北风","张山","李四","欧阳锋","郭靖","黄蓉","杨过","凤姐","芙蓉姐姐","移联网","樱木花道","风清扬","张三丰","梅超风"};;
        	mNicks = new String[2000];
        	for(int i=0;i<mNicks.length;i++){
            	mNicks[i]="happy"+i;
            System.out.println(mNicks[i]);
            }
        	return mNicks;
		}
    	
    	private String[] mNicks = name();
     ...
     * 昵称
     */
    private static String[] nicks = nicks1;
    /**  
     * 汉字转换位汉语拼音首字母，英文字符不变  
     * @param chines 汉字  
     * @return 拼音  
